  ...
  const projects: Project[] = [
    {
      ...
      link: 'https://faheemahamed.github.io/Responsive-Portfolio-Website/index.html'
    },
    {
      ...
      link: 'https://faheemahamed.github.io/Movie-Search-App/index.html'
    },
    {
      ...
      link: 'https://faheemahamed.github.io/Digital-Clock/index.html'
    },
    {
            ...
            <div key={index} className="h-full">
              {project.link ? (
                <a
                  ...
                  className="block h-full group bg-gradient-to-br from-gray-900 to-black border border-white/10 rounded-2xl overflow-hidden 
                ...
                >
                  ...
                  <div className="flex flex-col h-full">
                    ...
                    <div className="p-8 flex-grow flex flex-col">
                      ...
                      <p className="text-gray-400 text-base mb-8 line-clamp-3 leading-relaxed flex-grow">
                        {project.description}
                      </p>
                ...
                // Regular div for projects without links - Same structure as above
                <div className="h-full group bg-gradient-to-br from-gray-900 to-black border border-white/10 rounded-2xl overflow-hidden 
                  hover:border-[#768064]/50 transition-all duration-500 
                  hover:shadow-[0_0_50px_rgba(118,128,100,0.15)] hover:-translate-y-2"
                >
                  <div className="flex flex-col h-full">
