  ...
  return (
    <div className="min-h-screen bg-black py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-[800px] h-[800px] bg-cyan-500/5 rounded-full filter blur-[150px]"></div>
        <div className="absolute bottom-1/4 right-1/4 w-[800px] h-[800px] bg-blue-500/5 rounded-full filter blur-[150px]"></div>
      </div>

      <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8">
        {/* Enhanced header section */}
        <div className="text-center max-w-3xl mx-auto mb-24">
          <div className="inline-flex items-center gap-3 px-6 py-2.5 bg-cyan-400/10 border border-cyan-400/30 rounded-full mb-8">
            <FileText className="text-cyan-400" size={22} />
            <span className="text-cyan-400 font-semibold tracking-wider">RESUME</span>
          </div>
        ...
        <div className="space-y-24">
          ...
          <section>
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-br from-gray-900 to-black border border-white/10 rounded-2xl p-6 hover:border-cyan-400/40 transition-all duration-300 group">
                <div className="flex items-start justify-between mb-3">
                  <h3 className="text-xl font-bold text-cyan-400 group-hover:text-cyan-300">B.Tech – Computer Science & Engineering</h3>
                  <span className="px-3 py-1 bg-cyan-400/10 border border-cyan-400/30 rounded-full text-cyan-400 text-xs font-semibold">Ongoing</span>
                </div>
                ...
                <div className="flex items-center gap-2">
                  <div className="px-4 py-2 bg-white/5 border border-white/10 rounded-lg">
                    ...
                    <span className="text-cyan-400 font-semibold">7.9</span>
                  </div>
                </div>
              </div>
              <div className="bg-gradient-to-br from-gray-900 to-black border border-white/10 rounded-2xl p-6 hover:border-cyan-400/40 transition-all duration-300 group">
                <h3 className="text-xl font-bold text-cyan-400 group-hover:text-cyan-300 mb-2">Intermediate (MPC)</h3>
              ...
              <div className="bg-gradient-to-br from-gray-900 to-black border border-white/10 rounded-2xl p-6 hover:border-cyan-400/40 transition-all duration-300 group">
                <h3 className="text-xl font-bold text-cyan-400 group-hover:text-cyan-300 mb-2">SSC</h3>
                <p className="text-white mb-1 font-medium">Bhashyam High School</p>
                <p className="text-gray-400 text-sm mb-3">2020</p>
                <div className="px-4 py-2 bg-white/5 border border-white/10 rounded-lg inline-flex items-center gap-2">
                  <span className="text-gray-400 text-sm">Score: </span>
                  <span className="text-cyan-400 font-semibold">94.5%</span>
                </div>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-br from-gray-900 to-black border border-white/10 rounded-2xl p-6 hover:border-cyan-400/40 transition-all duration-300 group">
                <h3 className="text-xl font-bold text-cyan-400 group-hover:text-cyan-300 mb-2">Front-end Development Intern (Training)</h3>
              ...
              <div className="bg-gradient-to-br from-gray-900 to-black border border-white/10 rounded-2xl p-6 hover:border-cyan-400/40 transition-all duration-300 group">
                <h3 className="text-xl font-bold text-cyan-400 group-hover:text-cyan-300 mb-2">Web Development Intern (Training)</h3>
              ...
              <div className="bg-gradient-to-br from-gray-900 to-black border border-white/10 rounded-2xl p-6 hover:border-cyan-400/40 transition-all duration-300 group">
                <h3 className="text-xl font-bold text-cyan-400 group-hover:text-cyan-300 mb-2">Intern (Training)</h3>
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-gray-900 to-black border border-white/10 rounded-xl p-6 hover:border-cyan-400/40 transition-all duration-300 group">
                <h3 className="text-lg font-bold text-cyan-400 mb-3 group-hover:text-cyan-300">Front-End</h3>
                <div className="flex flex-wrap gap-2">
                  {['React.js', 'Angular', 'JavaScript', 'HTML', 'CSS', 'Bootstrap'].map((tech, i) => (
                    <span key={i} className="px-3 py-1 bg-cyan-400/5 border border-cyan-400/20 text-gray-300 text-xs rounded-full">{tech}</span>
                  ))}
                </div>
              </div>
              <div className="bg-gradient-to-br from-gray-900 to-black border border-white/10 rounded-xl p-6 hover:border-cyan-400/40 transition-all duration-300 group">
                <h3 className="text-lg font-bold text-cyan-400 mb-3 group-hover:text-cyan-300">Back-End</h3>
                <div className="flex flex-wrap gap-2">
              ...
              <div className="bg-gradient-to-br from-gray-900 to-black border border-white/10 rounded-xl p-6 hover:border-cyan-400/40 transition-all duration-300 group">
                <h3 className="text-lg font-bold text-cyan-400 mb-3 group-hover:text-cyan-300">Databases</h3>
                <div className="flex flex-wrap gap-2">
                  {['MySQL'].map((tech, i) => (
                    <span key={i} className="px-3 py-1 bg-cyan-400/5 border border-cyan-400/20 text-gray-300 text-xs rounded-full">{tech}</span>
                  ))}
              ...
              <div className="bg-gradient-to-br from-gray-900 to-black border border-white/10 rounded-xl p-6 hover:border-cyan-400/40 transition-all duration-300 group">
                <h3 className="text-lg font-bold text-cyan-400 mb-3 group-hover:text-cyan-300">Programming</h3>
                <div className="flex flex-wrap gap-2">
              ...
              <div className="bg-gradient-to-br from-gray-900 to-black border border-white/10 rounded-xl p-6 hover:border-cyan-400/40 transition-all duration-300 group">
                <h3 className="text-lg font-bold text-cyan-400 mb-3 group-hover:text-cyan-300">Tools</h3>
                <div className="flex flex-wrap gap-2">
          ...
          <section>
            ...
            <div className="bg-gradient-to-br from-gray-900 to-black border border-white/10 rounded-2xl p-6 hover:border-cyan-400/40 transition-all duration-300 group">
              <div className="flex items-start gap-4">
                <div className="w-16 h-16 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-xl flex items-center justify-center flex-shrink-0 text-black font-bold text-2xl group-hover:scale-110 transition-transform duration-300">
                  3rd
                </div>
                <div>
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {[
                ...
                <div key={index} className="bg-gradient-to-br from-gray-900 to-black border border-white/10 rounded-xl p-5 hover:border-cyan-400/40 transition-all duration-300 group">
          ...
          <section>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {['English', 'Hindi', 'Telugu'].map((lang, i) => (
                <div key={i} className="bg-gradient-to-br from-gray-900 to-black border border-white/10 rounded-xl p-5 text-center hover:border-cyan-400/40 transition-all duration-300 group">
                  <p className="text-white font-bold text-lg group-hover:text-cyan-400 transition-colors">{lang}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div className="bg-gradient-to-br from-gray-900 to-black border border-white/10 rounded-xl p-5 hover:border-cyan-400/40 transition-all duration-300 group">
                <div className="flex flex-col items-center text-center gap-3">
                  <div className="w-12 h-12 bg-cyan-400/10 rounded-xl flex items-center justify-center group-hover:bg-cyan-400/20 transition-all">
